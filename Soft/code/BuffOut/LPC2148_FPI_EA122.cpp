...
StringOut_EA122::StringOut_EA122 (EA122* display, int x, int  y, FONT_SET font,  int pitch, bool isInverted) : AbstractBuffOut(0)
{
	xPos = x;
	yPos = y;
	fntType = font;
...
bool StringOut_EA122::Send(const char* inp, unsigned int size)
{
	//(int x, int  y,  const char* str, const int font, int pitch, bool isInverted
	disp->WriteStr( xPos, yPos, inp, fntType, ptchSz, IsInv);
	return true;
}
